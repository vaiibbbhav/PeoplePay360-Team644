      ...
      <div className="h-28 bg-bg-raised border-b border-line relative px-4 sm:px-8 flex items-end justify-end pb-3">
        <div className="flex items-center gap-2">
          {onEdit && (
            <button
              onClick={onEdit}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-bg border border-line text-ink hover:bg-bg-raised transition-colors cursor-pointer shadow-2xs"
            >
