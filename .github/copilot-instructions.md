...
- ALWAYS use Tailwind CSS utility classes (`className="..."`). NEVER write inline styles (`style={{ ... }}`) or vanilla CSS classes unless strictly required for dynamic calculation.
