...
const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  ...
  'HR Payroll User': [
    ...
    'timeoff.read', 'timeoff.write', 'timeoff.approve',
    // Payrun & payslip CRU
    'payroll.payrun.read', 'payroll.payrun.create', 'payroll.payrun.update',
    'payroll.payslip.read', 'payroll.payslip.create', 'payroll.payslip.update',
  ...
  'HR Payroll Manager': [
    ...
    'schedules.read', 'schedules.write', 'schedules.delete',
    'timeoff.read', 'timeoff.write', 'timeoff.approve',
    'payroll.payrun.read', 'payroll.payrun.create', 'payroll.payrun.update', 'payroll.payrun.delete',
    'payroll.payslip.read', 'payroll.payslip.create', 'payroll.payslip.update', 'payroll.payslip.delete',
    'payroll.structure.read', 'payroll.structure.write', 'payroll.structure.delete',
    'payroll.rule.read', 'payroll.rule.write', 'payroll.rule.delete',
    'reporting.read',
  ],
